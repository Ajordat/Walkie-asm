...
;***********************************
    ...
    /* 
     *   EL QUE FEM A LA INTERRUPCIÓ ÉS TORNAR A INICIAR LA INTERRUPCIÓ, FICAR A 0 EL FLAG WAIT I 
     *   INCREMENTAR ELS COMPTADORS AMB LES SEGÜENTS FUNCIONS: CONTROLAR ELS REBOTS, CONTROLAR LA
